            ...
            {(() => {
              switch (detail) {
                ...
                case 'contact':
                  return (
                    <div className="help__content">
                      Email us at <a href="mailto:help@weprint.io">help@weprint.io</a> with any
                ...
                case 'about':
                  return (
                    <div className="help__content">
                      WePrint is a service which connects people looking to get 3D prints made with
                      those who make prints!
                    </div>
                  );
                default:
                  return <div></div>;
