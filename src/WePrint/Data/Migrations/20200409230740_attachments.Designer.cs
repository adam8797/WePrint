...
namespace WePrint.Data.Migrations
{
    ...
    [Migration("20200409230740_attachments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WePrint.Data.File", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WePrint.Data.Job", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WePrint.Data.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WePrint.Data.Printer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WePrint.Data.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WePrint.Data.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("WePrint.Data.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WePrint.Data.Bid", b =>
                {
                    b.HasOne("WePrint.Data.User", "Bidder")
                        .WithMany("Bids")
                        .HasForeignKey("BidderId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("WePrint.Data.Job", "Job")
                        .WithMany("Bids")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("WePrint.Data.Comment", b =>
                {
                    ...
                    b.HasOne("WePrint.Data.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WePrint.Data.Job", b =>
                {
                    ...
                    b.HasOne("WePrint.Data.User", "Customer")
                        .WithMany("Jobs")
                    ...
                    b.OwnsMany("WePrint.Data.JobAttachment", "Attachments", b1 =>
                        {
                            ...
                            b1.HasOne("WePrint.Data.User", "SubmittedBy")
                                .WithMany()
            ...
            modelBuilder.Entity("WePrint.Data.Pledge", b =>
                {
                    b.HasOne("WePrint.Data.User", "Maker")
                        .WithMany("Pledges")
                        .HasForeignKey("MakerId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("WePrint.Data.Project", "Project")
                        .WithMany("Pledges")
            ...
            modelBuilder.Entity("WePrint.Data.Printer", b =>
                {
                    b.HasOne("WePrint.Data.User", "Owner")
                        .WithMany("Printers")
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("WePrint.Data.Project", b =>
                {
                    b.HasOne("WePrint.Data.Organization", "Organization")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("WePrint.Data.ProjectUpdate", b =>
                {
                    b.HasOne("WePrint.Data.User", "PostedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("WePrint.Data.Review", b =>
                {
                    ...
                    b.HasOne("WePrint.Data.User", "ReviewedUser")
                        .WithMany("Reviews")
                        .HasForeignKey("ReviewedUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("WePrint.Data.User", "Reviewer")
                        .WithMany()
